...
<div className="moviebox  w-full bg-black px-5 py-10  whitespace-nowrap overflow-x-auto " style={{scrollbarWidth: "none"}}>
...
<div className="popularTV  w-full bg-black   px-5 py-5 whitespace-nowrap overflow-x-auto " style={{scrollbarWidth: "none"}}>
